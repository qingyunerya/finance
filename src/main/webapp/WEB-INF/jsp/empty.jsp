        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="http://localhost:8080/finance/empty" class="waves-effect active-menu waves-dark"><i class="fa fa-fw fa-file"></i>导出报表</a>
                    </li>
                </ul>
                                    ...
                                    <table class="table">
                                        ...
                                        <%
                                            ...
                                            for(Tab i:l)
                                            {
                                                add++;
                                        %>
                                        <form method="post" action="http://localhost:8080/finance/downloads">
