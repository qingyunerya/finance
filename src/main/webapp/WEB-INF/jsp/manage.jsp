        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="http://localhost:8080/finance/index" class="waves-effect waves-dark"><i class="fa fa-dashboard"></i>主页</a>
                    </li>
                    <li>
                        <a href="http://localhost:8080/finance/manage" class="active-menu waves-effect waves-dark"><i class="fa fa-desktop"></i>报表管理</a>
                    </li>
					<li>
        ...
        <div id="page-wrapper">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr class="success">
                                        ...
                                        <td><%=id%></td>
                                        <td>
                                            <button onclick="if(show_confirm()){this.form.action='http://localhost:8080/finance/deleteTable';this.form.submit()}" class="btn btn-danger" style="font-size: smaller">删除该表</button>
                                            <button onclick="if(show_confirm2()){this.form.action='http://localhost:8080/finance/adjTable';this.form.submit()}" class="btn btn-warning" style="font-size: smaller">修改表名</button>
                                        </td>
                                        </tr>
                                    </form>
                                        <%
		  ...
		  <div class="clearBoth"></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form class="bs-example bs-example-form" role="form" action="http://localhost:8080/finance/insertTable" method="post">
