...
<head>
    ...
    <link rel="Stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/loginDialog.css" />
...
<div class="inset center-block" style="width: 500px">
    ...
    <form action="sign_in" method="post">
        ...
        <div class="submit text-center">
            ...
            <a herf="javascript:alert('fdsf')" id="example" class="btn btn-info" style="margin-left: 15%" >注册</a>
            <div class="clear"> </div>
        </div>
    </form>
</div>
