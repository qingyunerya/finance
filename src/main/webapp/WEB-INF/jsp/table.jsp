        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="http://localhost:8080/finance/table" class="active-menu waves-effect waves-dark"><i class="fa fa-table"></i>报表修改</a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <form class="bs-example bs-example-form" role="form" method="post" action="http://localhost:8080/finance/insertInfo" style="width: 30%">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <%}%>
                                            ...
                                            <td class="center">
                                                <button onclick="this.form.action='http://localhost:8080/finance/adjInfo';this.form.submit()" class="btn btn-success">确定修改</button>
                                                <button onclick="if(show_confirm()){this.form.action='http://localhost:8080/finance/deleteInfo';this.form.submit()}" class="btn btn-danger">删除</button>
                                            </td>
                                        </tr>
                                        </form>
                                        <%
