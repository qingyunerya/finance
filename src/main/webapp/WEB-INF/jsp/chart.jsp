        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="http://localhost:8080/finance/chart" class="active-menu waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i>报表查询</a>
                    </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <form class="bs-example bs-example-form" role="form" method="post" action="http://localhost:8080/finance/search" style="width: 30%">
